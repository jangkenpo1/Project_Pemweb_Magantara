...
<head>
    ...
    <title>@yield('title', 'Admin Panel') — MaganTara</title>
...
<body style="background: var(--color-fog); min-height: 100vh; display: flex; flex-direction: column;">
    ...
    <nav class="navbar">
        <div class="navbar-inner">
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
                <span style="font-size: 14px; color: var(--color-ash);">{{ auth('admin')->user()->name }}</span>
    ...
    <div style="display: flex; flex: 1;">
        <aside class="sidebar">
            ...
            <nav>
                <a href="/admin/perusahaan" class="sidebar-link {{ request()->is('admin/perusahaan*') ? 'active' : '' }}">
                ...
                <a href="/admin/lowongan" class="sidebar-link {{ request()->is('admin/lowongan*') ? 'active' : '' }}">
            ...
            <nav>
                <a href="/admin/master/skill" class="sidebar-link {{ request()->is('admin/master/skill*') ? 'active' : '' }}">
                ...
                <a href="/admin/master/industri" class="sidebar-link {{ request()->is('admin/master/industri*') ? 'active' : '' }}">
                ...
                <a href="/admin/master/universitas" class="sidebar-link {{ request()->is('admin/master/universitas*') ? 'active' : '' }}">
