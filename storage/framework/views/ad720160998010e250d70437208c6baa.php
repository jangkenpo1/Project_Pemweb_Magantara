<?php $__env->startSection('title', 'Dashboard Perusahaan'); ?>
...
<?php $__env->startSection('content'); ?>
    <div style="margin-bottom: 32px;">
        ...
        <p style="font-size: 14px; color: var(--color-graphite);">Selamat datang, <strong><?php echo e($perusahaan->name); ?></strong></p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 32px;">
        ...
        <div class="stat-card">
            ...
            <p class="stat-number" style="font-size: 32px;"><?php echo e($totalLowongan); ?></p>
        ...
        <div class="stat-card">
            ...
            <p class="stat-number" style="font-size: 32px;"><?php echo e($lowonganAktif); ?></p>
        ...
        <div class="stat-card">
            ...
            <p class="stat-number" style="font-size: 32px;"><?php echo e($totalPelamar); ?></p>
        ...
        <div class="stat-card">
            ...
            <p class="stat-number" style="font-size: 32px;"><?php echo e($pelamarBaru); ?></p>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $lowongans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lowongan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div style="display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid rgba(163,166,175,0.2);">
                    <div style="flex: 1; min-width: 0;">
                        <a href="/perusahaan/lowongan/<?php echo e($lowongan->id); ?>/edit" style="font-size: 14px; font-weight: 500; color: var(--color-ink); text-decoration: none;"><?php echo e($lowongan->title); ?></a>
                        <p style="font-size: 12px; color: var(--color-graphite);"><?php echo e($lowongan->lamarans_count); ?> pelamar · Deadline <?php echo e($lowongan->deadline->format('d M')); ?></p>
                    </div>
        ...
        <div class="card">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $pelamarTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lamaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div style="display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid rgba(163,166,175,0.2);">
                    <div class="avatar-initials" style="width: 36px; height: 36px; font-size: 12px;"><?php echo e(strtoupper(substr($lamaran->mahasiswa->name, 0, 1))); ?></div>
                    <div style="flex: 1; min-width: 0;">
                        <p style="font-size: 14px; font-weight: 500; color: var(--color-ink);"><?php echo e($lamaran->mahasiswa->name); ?></p>
                        <p style="font-size: 12px; color: var(--color-graphite);"><?php echo e($lamaran->lowongan->title); ?></p>
                    </div>
                    <span class="badge status-<?php echo e($lamaran->status); ?>" style="font-size: 11px;"><?php echo e($lamaran->status_label); ?></span>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.perusahaan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PEMWEB_ASLI\resources\views/perusahaan/dashboard.blade.php ENDPATH**/ ?>