<?php $__env->startSection('title', 'Master Data: Skills'); ?>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr style="border-bottom: 1px solid rgba(163,166,175,0.15);">
                        <td style="padding: 16px; font-size: 14px; color: var(--color-ink);"><?php echo e($skill->name); ?></td>
                        <td style="padding: 16px; text-align: right;">
                            <form method="POST" action="/admin/master/skills/<?php echo e($skill->id); ?>" onsubmit="return confirm('Hapus skill ini?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PEMWEB_ASLI\resources\views/admin/master/skills.blade.php ENDPATH**/ ?>