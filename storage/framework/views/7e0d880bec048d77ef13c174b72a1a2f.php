...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — MaganTara Perusahaan</title>
...
<body style="background: var(--color-fog); min-height: 100vh; display: flex; flex-direction: column;">
        ...
        <div class="navbar-inner">
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <div style="display: flex; align-items: center; gap: 8px;">
                    <?php if(auth('perusahaan')->user()->logo): ?>
                        <img src="<?php echo e(Storage::url(auth('perusahaan')->user()->logo)); ?>" alt="Logo" class="company-logo">
                    <?php else: ?>
                        <div style="width:40px;height:40px;border-radius:12px;background:var(--color-fog);border:1px solid var(--color-dove);display:flex;align-items:center;justify-content:center;font-weight:700;color:var(--color-ink);font-size:16px;"><?php echo e(strtoupper(substr(auth('perusahaan')->user()->name, 0, 1))); ?></div>
                    <?php endif; ?>
                    <span style="font-size: 14px; font-weight: 500; color: var(--color-ash);"><?php echo e(auth('perusahaan')->user()->name); ?></span>
                </div>
    ...
    <div style="display: flex; flex: 1;">
        <!-- Sidebar -->
        <aside class="sidebar">
            <?php $perusahaan = auth('perusahaan')->user(); ?>

            <?php if($perusahaan->status_verification !== 'verified'): ?>
                <div class="verification-banner" style="margin-bottom: 20px;">
                    ...
                    <div>
                        <p style="font-size: 12px; font-weight: 600; color: var(--color-rust); margin: 0;"><?php echo e($perusahaan->status_verification === 'pending' ? 'Menunggu Verifikasi' : 'Verifikasi Ditolak'); ?></p>
            ...
            <nav>
                <a href="/perusahaan/dashboard" class="sidebar-link <?php echo e(request()->is('perusahaan/dashboard') ? 'active' : ''); ?>">
                ...
                <a href="/perusahaan/lowongan" class="sidebar-link <?php echo e(request()->is('perusahaan/lowongan*') ? 'active' : ''); ?>">
                ...
                <a href="/perusahaan/pelamar" class="sidebar-link <?php echo e(request()->is('perusahaan/pelamar*') ? 'active' : ''); ?>">
                ...
                <a href="/perusahaan/profil" class="sidebar-link <?php echo e(request()->is('perusahaan/profil*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\laragon\www\PEMWEB_ASLI\resources\views/layouts/perusahaan.blade.php ENDPATH**/ ?>